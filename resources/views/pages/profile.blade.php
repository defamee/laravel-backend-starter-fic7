                                ...
                                <div class="card-body">
                                     <div class="row">
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input type="password"
                                                name="current_password" class="form-control @error('current_password','updatePassword')
                                                    is-invalid
                                                @enderror"
                                                >
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
                                            <label>Phone</label>
                                            <input type="tel"
                                                name="phone" class="form-control @error('phone','updateProfileInformation')
                                                    is-invalid
                                                @enderror"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 @error('bio')
                                            is-invalid
                                        @enderror">
                                            <label>Bio</label>
                                            <textarea name="bio" class="form-control summernote-simple @error('bio','updateProfileInformation')
                                                is-invalid
